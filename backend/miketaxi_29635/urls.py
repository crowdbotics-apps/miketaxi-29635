"""miketaxi_29635 URL Configuration
...
admin.site.site_header = "mikeTaxi"
admin.site.site_title = "mikeTaxi Admin Portal"
admin.site.index_title = "mikeTaxi Admin"

# swagger
api_info = openapi.Info(
    title="mikeTaxi API",
    default_version="v1",
    description="API documentation for mikeTaxi App",
)
